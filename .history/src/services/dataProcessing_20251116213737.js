...
export const dataProcessing = {
    ...
    updateCompetitionNameMappings(mainHeaders) {
        ...
        if (hasChanges) {
            ...
            // Lưu ý: Việc lưu lên Cloud sẽ do một service khác (adminService) xử lý
            // khi người dùng nhập tên rút gọn trong tab Khai Báo.
        }
    },
    ...
    // ... (Các hàm khác như _findHeaderAndProcess, processThiDuaVungFile... 
    //      chúng ta sẽ thêm vào sau khi các lát cắt này chạy ổn)
    // === KẾT THÚC THÊM MỚI ===
};