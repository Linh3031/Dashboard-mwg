// Version 1.2 - Fix utils import and isNaN(Date) type error
// MODULE: SERVICES - DATA PROCESSING
// Chứa các hàm xử lý, chuẩn hóa, và phân tích cú pháp dữ liệu thô.

import { get } from 'svelte/store'; // <-- Dùng để đọc giá trị từ store
import { config } from './config.js';
import * as utils from './utils.js'; // <-- SỬA LỖI (V1.2): Import tất cả export vào object 'utils'
