<script>
  ...
  // === BẮT ĐẦU THAY ĐỔI (Import Store Kho) ===
  import { 
      danhSachNhanVien,
      rawGioCongData,
      ycxData,
  ...
  // ... (các biến state khác của file/paste giữ nguyên) ...
  ...
  // === BẮT ĐẦU THÊM MỚI (Lưu kho vào localStorage) ===
  ...
  $: if ($selectedWarehouse) {
      ...
      // (Trong tương lai, chúng ta sẽ thêm logic trigger cloud sync ở đây)
  }
  // === KẾT THÚC THÊM MỚI ===


  // ... (toàn bộ các hàm handleFileChange, handlePasteInput, debounce... giữ nguyên) ...
