...
// === BẮT ĐẦU THÊM MỚI (BƯỚC 2.2) ===
  ...
  // *** MODIFIED: Thêm ycxData ***
  import { danhSachNhanVien, ycxData } from '../stores.js';
...
// Reset input để có thể tải lại file y hệt
  ...
  // *** NEW: Hàm xử lý cho YCX (Tương tự DSNV) ***
...
<div class="progress-bar" style="width: 100%; background-color: #3b82f6;"></div>
            ...
            <div class="data-input-group input-group--blue h-full">
                <a href="https://bi.thegioididong.com/sieu-thi-con?id=16612&tab=1" target="_blank" class="data-input-group__label data-input-group__label--link">
                    <i data-feather="clipboard" class="h-5 
w-5 feather"></i>
        ...
        <i data-feather="clipboard" class="h-5 w-5 feather"></i>
                ...
                <div class="data-input-group__content">
                    <textarea id="paste-thiduanv" rows="5" class="data-textarea" placeholder="Dán dữ liệu 
đã sao chép..."></textarea>
 ...
 <span>Thưởng nóng:</span>
    ...
    <div class="content-card data-card--yellow"> 
        ...
        <p class="text-sm text-yellow-800 bg-yellow-100 p-3 rounded-lg mb-4">Lưu ý: Dữ liệu trong phần này sẽ được lưu vào trình duyệt của bạn.
Dữ liệu sẽ tồn tại cho đến khi bạn cập nhật lại.</p> 
...
Rà soát kỹ lỗi a11y và thực hiện bước tiếp theo (thêm logic xử lý file "Yêu cầu xuất lũy kế") như bạn đã trình bày. 
Tôi đã gửi nội dung file DataSection.svelte.