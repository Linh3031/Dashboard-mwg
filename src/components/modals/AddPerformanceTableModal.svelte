<script>
    ...
    // null = tạo mới, object = sửa
    export let isSystem = false;
    // true = Admin tạo, false = User tạo
    ...
    // [MỚI] Cấu hình lựa chọn metric cho cột Tỷ lệ
    ...
    $: if (isOpen) {
        if (!wasOpen) {
            ...
            if (editItem) {
                ...
                // [MỚI] Map thêm percentMetric nếu dữ liệu cũ chưa có
    ...
    function addColumn() {
        columns = [...columns, {
            ...
            denominator: [],
            targetId: null,
            percentMetric: 'DT' // [MỚI] Mặc định tính theo Doanh thu
        }];
                        ...
                        {#if activeColumn.type === 'PERCENT'}
                            ...
                            <div class="flex flex-col items-center justify-center mb-4 gap-2">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-[10px] font-bold text-gray-400 uppercase">Tính theo:</span>
