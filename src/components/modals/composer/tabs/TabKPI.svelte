...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-2">
        <button class="tag-btn w-full text-left" on:click={() => sendTag('[DT_THUC]')}>Doanh thu Thực</button>
        <button class="tag-btn w-full text-left" on:click={() => sendTag('[DTQD]')}>Doanh thu Quy đổi</button>
