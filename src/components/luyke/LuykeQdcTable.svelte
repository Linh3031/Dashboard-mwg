           ...
           <div class="flex items-center gap-3">
               ...
               <div class="flex-grow min-w-0 relative qdc-content-wrapper">
                   ...
                   <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden mb-1 shadow-inner relative z-0 qdc-bar-row">
                       <div class="h-full rounded-full shadow-sm transition-all duration-500 ease-out" style="width: {percent}%; background-color: {barColor};"></div>
                   </div>
...
<style>
    ...
    /* --- PHẪU THUẬT LOGIC CHIỀU CAO BAR --- */
    ...
    /* Đóng băng hiệu ứng animation khi chụp để màu không bị delay */
    :global(.capture-container *) {
        transition: none !important;
        animation: none !important;
    }
    
    /* --- XÓA SHADOW GÂY NHIỄU VÀ BƠM CHIỀU CAO CHO DIV CON --- */
    :global(.capture-container .qdc-bar-row > div) {
    ...
    :global(.capture-container .luyke-widget) {
        display: block !important;
        height: auto !important;
    }
    :global(.capture-container .luyke-widget-body) {
        display: block !important;
        height: auto !important;
