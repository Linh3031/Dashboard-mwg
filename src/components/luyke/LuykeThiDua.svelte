<script>
    ...
    // [PHẪU THUẬT LOGIC]: Import Component ALL Kho mới tách
...
<style>
    ...
    :global(.capture-container .luyke-dashboard-container) { width: 100% !important; min-width: 1200px !important; background-color: white; padding: 20px !important; }
