<script>
  ...
  // Import Bảng Dữ Liệu (File bạn đã có từ bước trước)
  import RealtimeEmployeeEfficiencyTable from './RealtimeEmployeeEfficiencyTable.svelte';
  ...
  $: {
    ...
    // 2. Tính Master Report (đã bao gồm các chỉ số pctPhuKien, pctGiaDung...)
...
<div class="animate-fade-in pb-10">
  {#if filteredReport.length > 0}
    <RealtimeEmployeeEfficiencyTable reportData={filteredReport} />
  {:else}
