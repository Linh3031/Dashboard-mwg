// src/config.js
// Version 2.5 - Atomic Integrity: Switch revenue target column to 'Giá bán_1'
...
export const config = {
    ...
    COLUMN_MAPPINGS: {
        ...
        ycx: {
            ...
            // [PHẪU THUẬT v3.4]: Đổi mục tiêu định danh sang cột 'Giá bán_1'
