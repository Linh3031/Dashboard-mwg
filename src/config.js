// Version 1.0 - Initial config file (Ported from old project)
// MODULE: CONFIG
// Chứa tất cả các cấu hình tĩnh của ứng dụng.

// Thay vì export ở cuối, chúng ta export trực tiếp hằng số 'config'
export const config = {
